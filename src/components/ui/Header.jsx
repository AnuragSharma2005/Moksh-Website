        ...
        <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="relative">
             <div className="w-10 h-10 bg-moksha-gradient rounded-lg flex items-center justify-center shadow-subtle overflow-hidden">
                <img
                  src="/Homepage.jpg"
                  alt="Moksh Digital Logo"
                  className="w-full h-full object-contain" // ✅ image fits inside background
                />
              </div>
